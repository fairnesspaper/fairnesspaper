...
# original
save_path=../checkpoints/bertbase/bertbase_original.bin
echo "original"
...
# penalty negative
save_path=../checkpoints/bertbase/bertbase_penalty_neg.bin
...
# penalty positive
save_path=../checkpoints/bertbase/bertbase_penalty_pos.bin
experiment=penalty_pos
echo "penalty positive"
python train_regularized.py -vocab ${base_model} -pretrain ${base_model} -res ${res_path} -save ${save_path} -n_warmup_steps ${n_warmup_steps} -batch_size ${batch_size} -lr ${learning_rate} -experiment ${experiment} -max_doc_len ${max_doc_len} -max_query_len ${max_query_len}

# penalty both
save_path=../checkpoints/bertbase/bertbase_penalty_both.bin
experiment=penalty_both
echo "penalty both"
python train_regularized.py -vocab ${base_model} -pretrain ${base_model} -res ${res_path} -save ${save_path} -n_warmup_steps ${n_warmup_steps} -batch_size ${batch_size} -lr ${learning_rate} -experiment ${experiment} -max_doc_len ${max_doc_len} -max_query_len ${max_query_len}

# fairness neg
save_path=../checkpoints/bertbase/bertbase_fairness_neg.bin
experiment=reward_neg
echo "fairness neg"
python train_regularized.py -vocab ${base_model} -pretrain ${base_model} -res ${res_path} -save ${save_path} -n_warmup_steps ${n_warmup_steps} -batch_size ${batch_size} -lr ${learning_rate} -experiment ${experiment} -max_doc_len ${max_doc_len} -max_query_len ${max_query_len}

# fairness pos
save_path=../checkpoints/bertbase/bertbase_fairness_pos.bin
...
# fairness both
save_path=../checkpoints/bertbase/bertbase_fairness_both.bin
