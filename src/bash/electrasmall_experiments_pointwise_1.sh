...
# # original
# save_path=/mnt/data/shirin/bias_aware_loss_journal/checkpoints/electrasmall/pointwise_regression/electrasmall_original_1.bin
# echo "original"
...
# penalty negative
save_path=/mnt/data/shirin/bias_aware_loss_journal/checkpoints/electrasmall/pointwise_regression/electrasmall_penalty_neg_6.bin
...
# penalty positive
# save_path=/mnt/data/shirin/bias_aware_loss_journal/checkpoints/electrasmall/pointwise_regression/electrasmall_penalty_pos_1.bin
# experiment=penalty_pos
# echo "penalty positive"
# python ../train_regularized_regression.py -vocab ${base_model} -pretrain ${base_model} -res ${res_path} -save ${save_path} -n_warmup_steps ${n_warmup_steps} -batch_size ${batch_size} -lr ${learning_rate} -experiment ${experiment} -max_doc_len ${max_doc_len} -max_query_len ${max_query_len} -task ${task} -train ${dataset} -regularizer_neg ${regularizer_neg} -regularizer_pos ${regularizer_pos}

# penalty both
save_path=/mnt/data/shirin/bias_aware_loss_journal/checkpoints/electrasmall/pointwise_regression/electrasmall_penalty_both_6.bin
experiment=penalty_both
echo "penalty both"
python ../train_regularized_regression.py -vocab ${base_model} -pretrain ${base_model} -res ${res_path} -save ${save_path} -n_warmup_steps ${n_warmup_steps} -batch_size ${batch_size} -lr ${learning_rate} -experiment ${experiment} -max_doc_len ${max_doc_len} -max_query_len ${max_query_len} -task ${task} -train ${dataset} -regularizer_neg ${regularizer_neg} -regularizer_pos ${regularizer_pos}

# fairness neg
# save_path=/mnt/data/shirin/bias_aware_loss_journal/checkpoints/electrasmall/pointwise_regression/electrasmall_fairness_neg_1.bin
...
# fairness pos
# save_path=/mnt/data/shirin/bias_aware_loss_journal/checkpoints/electrasmall/pointwise_regression/electrasmall_fairness_pos_1.bin
...
# fairness both
# save_path=/mnt/data/shirin/bias_aware_loss_journal/checkpoints/electrasmall/pointwise_regression/electrasmall_fairness_both_1.bin
